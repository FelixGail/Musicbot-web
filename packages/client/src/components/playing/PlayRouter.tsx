...
export const PlayRouter = () => {
  ...
  const jsx = useMemo(() => (<PlayerStateContext.Provider value={{state: playerState, history: history, queue: queue}}>
    <Route path="*/listen" component={ListenRouter} />
    <Route path="*/add" component={SearchRouter} />
  </PlayerStateContext.Provider>), [playerState, history, queue]);
